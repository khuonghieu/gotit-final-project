...
export const FETCH_CATEGORY_URL = (offset, limit) => (`http://localhost:5000/categories/?offset=${offset}&limit=${limit}`);
export const VIEW_CATEGORY = (categoryId) => (`http://localhost:5000/categories/${categoryId}`);
