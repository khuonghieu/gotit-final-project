...
export const CREATE_ITEM_URL = (categoryId) => (`${CONFIG.URL}/categories/${categoryId}/items`);
export const VIEW_ITEMS_URL = (categoryId, offset, limit) => (`${CONFIG.URL}/categories/${categoryId}/items?offset=${offset}&limit=${limit}`);
